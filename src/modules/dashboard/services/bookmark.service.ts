...
export class BookmarkService extends ObservableStore<StoreState> {
    private baseUrlCreateBookMark = 'https://myorgbookmarkurlapp.herokuapp.com/api/v1/bookmark/addbookmark';
    private baseUrlgetBookMarks = 'https://myorgbookmarkurlapp.herokuapp.com/api/v1/bookmark/GetAllcards';
    private baseUrlApproveBookMark = 'https://myorgbookmarkurlapp.herokuapp.com/api/v1/bookmark/Approve';
