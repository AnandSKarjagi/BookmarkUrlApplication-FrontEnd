...
export class UserService extends ObservableStore<StoreState> {
    private baseUrlRegister = 'https://myorgbookmarkurlapp.herokuapp.com/api/v1/account/register';
    private baseUrlAuth = 'https://myorgbookmarkurlapp.herokuapp.com/api/v1/account/auth';
